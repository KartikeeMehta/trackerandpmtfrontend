    ...
    <div className="bg-gradient-to-br from-blue-50 via-indigo-50 to-purple-50 min-h-screen">
          ...
          <div className="flex flex-col md:flex-row md:items-center md:justify-between gap-4">
            <div>
              ...
              <p className="text-base text-gray-700/80 mt-1">
                Install the desktop tracker on your system and enter the OTP below when prompted to pair this dashboard with your app.
              </p>
            </div>
          </div>
        </div>
          ...
          <div className="flex flex-col lg:flex-row lg:items-center lg:justify-between gap-6">
            <div className="flex-1">
              <div className="flex items-center gap-3 mb-4">
                <span className="inline-flex items-center justify-center w-10 h-10 rounded-lg bg-blue-100 text-blue-700">🔐</span>
                <div className="text-lg font-semibold text-gray-700">Your Pairing Code</div>
              </div>
      ...
      <div className="grid grid-cols-1 lg:grid-cols-2 gap-6 mb-8">
        ...
        <div className="backdrop-blur-md bg-white/40 border border-white/60 shadow-sm rounded-xl p-6">
          <div className="flex items-center gap-3 mb-4">
            ...
            <div className="text-lg font-semibold text-gray-700">Connection Status</div>
          </div>
          <div className="flex items-center gap-3">
            <div className={`inline-flex items-center px-4 py-2 rounded-full text-sm font-medium ${pairStatus === "paired" ? "bg-green-100 text-green-700" : pairStatus === "pending" ? "bg-yellow-100 text-yellow-700" : "bg-gray-100 text-gray-700"}`}>
        ...
        <div className="backdrop-blur-md bg-white/40 border border-white/60 shadow-sm rounded-xl p-6">
          <div className="flex items-center gap-3 mb-4">
            ...
            <div className="text-lg font-semibold text-gray-700">Download Desktop App</div>
          </div>
      ...
      <div className="backdrop-blur-md bg-white/40 border border-white/60 shadow-sm rounded-xl p-6">
        <div className="flex items-center gap-3 mb-6">
          ...
          <div className="text-lg font-semibold text-gray-700">Setup Instructions</div>
        </div>
        <div className="grid grid-cols-1 md:grid-cols-2 gap-6">
          <div className="space-y-4">
            <div className="flex items-start gap-3">
              <div className="flex-shrink-0 w-8 h-8 bg-blue-100 text-blue-700 rounded-full flex items-center justify-center text-sm font-semibold">1</div>
              <div>
                <div className="font-medium text-gray-700">Download & Install</div>
                <div className="text-sm text-gray-600">Download and install the Tracker app for your operating system using the buttons above.</div>
              </div>
            </div>
            <div className="flex items-start gap-3">
              <div className="flex-shrink-0 w-8 h-8 bg-blue-100 text-blue-700 rounded-full flex items-center justify-center text-sm font-semibold">2</div>
              <div>
                <div className="font-medium text-gray-700">Launch Application</div>
                <div className="text-sm text-gray-600">Open the app and click "Connect to Dashboard" to start the pairing process.</div>
              </div>
            </div>
          </div>
          <div className="space-y-4">
            <div className="flex items-start gap-3">
              <div className="flex-shrink-0 w-8 h-8 bg-blue-100 text-blue-700 rounded-full flex items-center justify-center text-sm font-semibold">3</div>
              <div>
                <div className="font-medium text-gray-700">Enter Credentials</div>
                <div className="text-sm text-gray-600">
                  Enter your email ({email || "your email"}) and the OTP code shown above.
                </div>
              </div>
            </div>
            <div className="flex items-start gap-3">
              <div className="flex-shrink-0 w-8 h-8 bg-blue-100 text-blue-700 rounded-full flex items-center justify-center text-sm font-semibold">4</div>
              <div>
                <div className="font-medium text-gray-700">Complete Pairing</div>
                <div className="text-sm text-gray-600">Upon successful connection, your tracker will be paired to this account.</div>
              </div>
            </div>
          </div>
        </div>
